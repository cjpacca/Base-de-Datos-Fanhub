...
SELECT
  ...
  AVG(f.monto_total) AS 'Gasto Promedio Mensual'
FROM Usuario u
...
CREATE VIEW v_viralidad_categoria AS
...
CREATE OR ALTER VIEW v_clasificacion_ganancias AS
